...
def quaternion_to_eulerRPY(orientation_in_quat):
    ...
    orientation_in_euler = euler_from_quaternion(explicit_orient_in_quat)
    return TO_DEGREE(orientation_in_euler[0]), TO_DEGREE(orientation_in_euler[1]), TO_DEGREE(orientation_in_euler[2])
...
class XSensDriver(object):
    ...
    def __init__(self):
        ...
        self.diag_pub = None
        self.imu_pub = None
        self.euler_yaw_pub = None
        self.euler_pitch_pub = None
        self.euler_roll_pub = None
    ...
    def spin_once(self):
        ...
        if self.pub_imu:
            ...
            if self.imu_pub is None:
                self.imu_pub = rospy.Publisher('anahita/imu', Imu, queue_size=10)
